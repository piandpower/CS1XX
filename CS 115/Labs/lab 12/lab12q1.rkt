...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname lab12q1) (read-case-sensitive #t) (teachpacks ((lib "taxon.rkt" "installed-teachpacks") (lib "compound.rkt" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "taxon.rkt" "installed-teachpacks") (lib "compound.rkt" "installed-teachpacks")))))
(define-struct card (value suit))
;; A card is a structure  v s), where
;;      v is an integer in the range 1 to 10 and
;;      s is a symbol in the set , 'diamonds, 'spades, and 'clubs.
...
(define (make-canadian string)
  (local
    [(define (canadianize e)
       (cond [(equal? "o" e) "ou"]
             [else e]))]
    (foldr string-append "" (map canadianize 
                                 (explode string)))))
