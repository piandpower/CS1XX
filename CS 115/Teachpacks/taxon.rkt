#lang racket
  ...
  ;; A t-modern is a structure (make-t-modern n p), where n is a string and p is a number.
  
  ;; A t-ancient is a structure (make-t-ancient n a l r), where n is a string, a is a number,
  ;; and l and r are taxons.
